...
public class MypageController {
    ...
    public ResponseEntity<?> myPage(@AuthenticationPrincipal TblUser user){
    ...
    public ResponseEntity<?> updateNickname(@RequestBody String nickname,@AuthenticationPrincipal TblUser user){
        String oldNickname = user.getNickname();
        String result = mypageService.updateNickname(user,nickname);
